...
public abstract class Item extends JLabel implements MouseMotionListener, MouseListener, ActionListener {
    ...
    public void Equip(int slot) {
        Systems.SoundSystem.SoundPlayer.playSound(new File(Player.RsrcFolder + "\\Sound\\Effects\\equip").listFiles()[rnd.nextInt(new File(Player.RsrcFolder + "\\Sound\\Effects\\equip").listFiles().length)]);
    }
